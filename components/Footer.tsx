...
const Footer = () => {
    return (
        <footer className='w-full mb-[100px] pb-10 md:mb-9' id='contact'>
            ...
            <div className='flex flex-col items-center'>
                ...
                <a href="mailto:abhishekguleria@gmail.com" target='_blank'>
                    <MagicButton2 title="Get in touch" icon={<FaLocationArrow />} position='right' />
                </a>
            </div>
            <div className='flex mt-16 md:flex-row flex-col justify-between items-center'>
                <p className='md:text-base text-sm md:font-normal font-light'>Copyright © 2024 Abhig-1599</p>
