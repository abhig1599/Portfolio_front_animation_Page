...
export const BentoGridItem = ({
    ...
    const leftLists = ["React.js", "Tailwind", "Typescript", "Next.js", "Cloudflare", "Ethers.js", "solidity"];
    const rightLists = ["Node.js", "PostgresSQL", "Express.js", "MongoDB", "Hono", "Figma"];
    ...
    const handleCopy = () => {
        const text = "abhishekguleria1599@gmail.com";
            ...
            <div className={`${id === 6 && "flex justify-center"} h-full`}>
                ...
                >
                    ...
                    {id === 3 && (
                        ...
                        // </div>
                        <div>
                        <InfiniteMovingCards skills={leftLists} speed="fast" direction="left"/>
                        <InfiniteMovingCards skills={rightLists} speed="fast" direction="right"/>
                        </div>
                    )}
                    {id === 6 && (
